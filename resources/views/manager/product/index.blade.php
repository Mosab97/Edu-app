            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                ...
                <div class="kt-portlet__body">
                    <table class="table text-center" id="users-table">
                        ...
                        <th>{{t('Category')}}</th>
                        <th>{{t('Price (Piece)')}}</th>
                        <th>{{t('Price (Retailer, Wholesaler)')}}</th>
                        <th>{{t('Quantity')}}</th>
                        <th>{{t('Date')}}</th>
                        <th>{{t('Actions')}}</th>
                        </thead>
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.deleteRecord', (function () {
                var id = $(this).data("id");
                var url = '{{ route("manager.product.destroy", ":id") }}';
            ...
            $(function () {
                $('#users-table').DataTable({
                    ...
                    searching: false,
                    ajax: {
                        url: '{{ route('manager.product.index') }}',
                        data: function (d) {
                            d.search = $("#search").val();
                        }
                    },
                    columns: [
                        ...
                        {data: 'piece_retailer_wholesaler', name: 'piece_retailer_wholesaler'},
