...
<head>
    ...
    <link href="{{ asset("assets/css/demo6/pages/general/login/login-6.".direction('.')."css") }}" rel="stylesheet"
          type="text/css"/>
                ...
                <div class="kt-login__wrapper">
                            ...
                            <div class="kt-login__signin">
                                <div class="kt-login__form">
                                    ...
                                    <form class="form-horizontal" role="form" method="POST"
                                          action="{{ url('/manager/password/reset') }}">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            <input
                                                ...
                                                type="password" placeholder="{{ t('Password Confirmation') }}"
                    ...
                    <div class="kt-login__account">
                                    <span class="kt-login__account-msg">
                                        {{ date('Y') }}&nbsp;&copy;&nbsp;<a href="https://manaratalharamain.gov.sa/"
                                                                            target="_blank"
                                                                            class="kt-link kt-font-danger"></a>
                                    </span>&nbsp;&nbsp;|
                        <span class="kt-login__account-msg">
                             @if(app()->getLocale() == "en")
                ...
                <div class="kt-login__section">
                    <div class="kt-login__block text-center">
                        ...
                        <h3 class="kt-login__title"
                            style="font-size: 2.2rem">{{ t('Control Panel for System Management') }}</h3>
