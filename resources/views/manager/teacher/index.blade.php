                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('manager.'.\App\Models\User::manager_route_user_type['teacher'].'.create') }}"
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.deleteRecord', (function () {
                var id = $(this).data("id");
                var url = '{{ route('manager.'.\App\Models\User::manager_route_user_type['teacher'].'.destroy', ":id") }}';
            ...
            $(function () {
                $('#users-table').DataTable({
                    ...
                    ajax: {
                        url: '{{ route('manager.'.\App\Models\User::manager_route_user_type['teacher'].'.index') }}',
                        data: function (d) {
                            d.search = $("#search").val();
                            d.name = $("#name").val();
                        }
