...
@section('content')
    @push('breadcrumb')
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('manager.'.\App\Models\User::manager_route_user_type['teacher'].'.index') }}">{{ t('Teachers') }}</a>
        </li>
        <li class="breadcrumb-item">
            {{ t('Show Teacher') }}
        </li>
                ...
                <div class="kt-portlet__body">
                    <ul class="nav nav-tabs  nav-tabs-line nav-tabs-line-warning" role="tablist">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link active" data-toggle="tab" href="#groups" role="tab">{{ t('Groups') }}</a>
                        </li>
                        {{--                        <li class="nav-item">--}}
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="groups" role="tabpanel">
                            <table class="table text-center" id="groups-table">
                                <thead>
                                <th>{{ t('Name') }}</th>
                                <th>{{ t('Course') }}</th>
                                <th>{{ t('Level') }}</th>
    ...
    <script>
        ...
        $(function () {
            var table = $('#groups-table').DataTable({
                ...
                ajax: {
                    url: '{{ route('manager.'.\App\Models\Group::ui['manager_route'].'.index') }}',
                    data: function (d) {
                        d.teacher = "{{$user->id}}"
                    }
                },
