                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('manager.customer_review.create') }}"
                                   class="btn btn-danger btn-elevate btn-icon-sm">
                                    <i class="la la-plus"></i>
                                    {{t('Add Customer Review')}}
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.deleteRecord', (function () {
                var id = $(this).data("id");
                var url = '{{ route("manager.customer_review.destroy", ":id") }}';
            ...
            $(function () {
                $('#users-table').DataTable({
                    ...
                    searching: false,
                    ajax: {
                        url: '{{ route('manager.customer_review.index') }}',
                        data: function (d) {
                            d.name = $("#name").val();
                            d.status = $("#status").val();
                        }
