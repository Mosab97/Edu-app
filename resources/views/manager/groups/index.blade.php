...
@section('content')
    @push('breadcrumb')
        <li class="breadcrumb-item">
            {{t(\App\Models\Group::ui['plural_name'])}}
        </li>
    @endpush
    @push('search')
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('manager.'.\App\Models\Group::ui['manager_route'].'.create') }}"
                                   class="btn btn-danger btn-elevate btn-icon-sm">
                                    <i class="la la-plus"></i>
                                    {{t('Add ' . \App\Models\Group::ui['single_name'])}}
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.deleteRecord', (function () {
                var id = $(this).data("id");
                var url = '{{ route('manager.'.\App\Models\Group::ui['manager_route'].'.destroy', ":id") }}';
