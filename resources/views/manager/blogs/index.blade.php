                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route(\App\Models\Blog::manager_route.'create') }}"
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.deleteRecord', (function () {
                var id = $(this).data("id");
                var url = '{{ route(\App\Models\Blog::manager_route."destroy", ":id") }}';
            ...
            $(function () {
                $('#users-table').DataTable({
                    ...
                    searching: false,
                    ajax: {
                        url: '{{ route(\App\Models\Blog::manager_route.'index') }}',
                        data: function (d) {
                            d.name = $("#name").val();
                            d.status = $("#status").val();
                        }
