            ...
            <div class="kt-portlet kt-portlet--height-fluid">
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            <div class="kt-portlet__head-actions">
                                <a href="{{ route('manager.offer.create') }}"
                ...
                <div class="kt-portlet__body">
                    <table class="table text-center" id="users-table">
                        ...
                        <th>{{t('Name')}}</th>
                        <th>{{t('Piece Cost')}}</th>
                        <th>{{t('Retailer Package Cost')}}</th>
                        <th>{{t('Wholesaler Package Cost')}}</th>
                        <th>{{t('Remaining')}}</th>
                        <th>{{t('Status')}}</th>
                        <th>{{t('Actions')}}</th>
                        </thead>
    ...
    <script>
        $(document).ready(function () {
            $(document).on('click', '.deleteRecord', (function () {
                var id = $(this).data("id");
                var url = '{{ route("manager.offer.destroy", ":id") }}';
            ...
            $(function () {
                $('#users-table').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'name', name: 'name'},
                        {data: 'piece_cost', name: 'piece_cost'},
                        {data: 'retailer_package_cost', name: 'retailer_package_cost'},
                        {data: 'wholesaler_package_cost', name: 'wholesaler_package_cost'},
                        {data: 'remaining', name: 'remaining'},
                        {data: 'status_offer', name: 'status_offer'},
