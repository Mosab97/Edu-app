...
@section('content')
    @push('breadcrumb')
        <li class="breadcrumb-item">
            <a href="{{ route('manager.category.index') }}">{{t('Category')}}</a>
        </li>
        <li class="breadcrumb-item">
        ...
        <div class="col-xl-12">
            <div class="kt-portlet">
                ...
                <form enctype="multipart/form-data" id="form_information" class="kt-form kt-form--label-right"
                      action="{{route('manager.category.store') }}" method="post">
                    {{ csrf_field() }}
                    @if(isset($category))
                            ...
                            <div class="kt-section__body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        ...
                                        <img id="blah"
                                             @if(!isset($category) || is_null($category->getOriginal('image'))) style="display:none"
                                             @endif src="{{ isset($category) && !is_null($category->getOriginal('image'))  ? url($category->image):'' }}"
