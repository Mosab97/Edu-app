    ...
    <div class="row">
        <div class="col-xl-10 offset-1">
            <div class="kt-portlet">
                ...
                <form action="{{ route('manager.manager_roles.update',$role->id ) }}" method="post" class="kt-form kt-form--label-right">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
    <div class="container mt-2">
        <div class="row">
            ...
            <table class="table table-striped table-bordered w-100">
                    <thead>
                    <th colspan="4" class=""><strong>{{ t('Permissions') }}:</strong> <input type="checkbox" onClick="toggle(this)" /> Check All<br/></th>
                    </thead>
                    <tbody>
